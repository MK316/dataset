...
@st.cache_data
def load_data():
    return pd.read_csv("https://raw.githubusercontent.com/MK316/dataset/refs/heads/main/S250529.csv")  # Replace with your actual CSV path
...
with tabs[4]:
    ...
    # ax.set_ylim(df["Midterm2"].min() - 10, df["Score"].max() + 10)
